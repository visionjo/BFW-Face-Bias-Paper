...
\def\FGPaperID{41} % *** Enter the FG 2019 Paper ID here
...
\author{\parbox{16cm}{\centering
    ...
    % $^2$ ISM Connect, Cambridge, MA, USA}}
    \thanks{}% <-this % stops a space
}


% \author{Joseph P Robinson$^1$, Yuncheng Li$^{2}$, Ning Zhang$^{2}$, Yun Fu$^{1}$, and Sergey Tulyakov$^{2}$\\
% \hspace{-.4in}$^{1}$Northeastern University\hspace{.7in} $^{2}$Snap Inc. \\\vspace{2mm}
% } %\\
...
\begin{tabular}{l c c c c c}
        ...
        CF &  \textbf{0.529}&  0.480&0.438&0.447 &0.474\pm0.041 \\
        CM & 0.456 & \textbf{0.504}  & 0.444 &0.362 &0.441\pm0.059 \\
        WF & 0.447 &0.438 &  \textbf{0.573}& 0.480 & 0.485\pm0.062 \\
        WM & 0.301&0.474 &  0.453 & \textbf{0.561} & 0.447\pm0.108 \\\midrule
        Avg &  0.433& 0.474&0.477 &0.463 &0.462\pm0.020\\
 \end{tabular}}
 \end{center}
 \vspace{-5mm}
\end{table} 
